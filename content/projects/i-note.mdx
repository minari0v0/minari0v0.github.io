...
![프로젝트아키텍처](/images/projects/i-note/project-architecture.png)
...
<ImageCarousel
  ...
  images={[
    {
      src: "/images/projects/i-note/main-teacher.png",
      alt: "교사 메인 페이지",
      caption: "교사 전용 대시보드로, 오늘 예정된 일정과 출결 현황을 한눈에 확인할 수 있습니다."
    },
    {
      src: "/images/projects/i-note/calender-teacher.png",
      alt: "교사 일정 페이지",
      caption: "원아들의 교육 일정 및 행사 일정을 관리하는 달력 화면입니다."
    },
    {
      src: "/images/projects/i-note/admin-teacher.png",
      alt: "아이 관리 페이지",
      caption: "담당 반의 원아 목록을 조회하고, 신규 원아 등록 및 기본 인적사항을 관리합니다."
    },
    {
      src: "/images/projects/i-note/administ-teacher.png",
      alt: "아이 상세 관리 페이지",
      caption: "개별 원아의 발달 사항 기록, 건강 체크 및 학부모 비상 연락망 등을 상세히 확인합니다."
    },
    {
      src: "/images/projects/i-note/notice-teacher.png",
      alt: "알림장 작성 페이지",
      caption: "학부모에게 전달할 일일 공지사항과 활동 내역을 작성하는 공간입니다."
    },
    {
      src: "/images/projects/i-note/memo-teacher.png",
      alt: "관찰일지 작성 페이지",
      caption: "수업 시간 중 관찰한 아이들의 특이사항과 행동 양식을 간편하게 기록하고 분석합니다."
    }
  ]}
/>
...
<ImageCarousel
  ...
  images={[
    {
      src: "/images/projects/i-note/main-parent.png",
      alt: "학부모 메인 페이지",
      caption: "학부모 전용 대시보드 화면입니다. 오늘 자녀의 기분, 식사 상태 및 당일 알림장을 바로 확인합니다."
    },
    {
      src: "/images/projects/i-note/memo-parent.png",
      alt: "학부모용 관찰일지 페이지",
      caption: "선생님이 작성한 자녀의 발달 요약 보고서와 관찰 분석 결과를 시각화하여 확인합니다."
    }
  ]}
/>
